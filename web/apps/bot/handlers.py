...
def create_keyboard_for_block(labels, one_time=True):
    ...
    four_buttons_template = [
        [{
            "action": {
                "type": "text",
                "payload": str({"option_button": str(labels[0][0])}),
                "label": labels[0][1]
            },
            "color": "default"
        },
        {
            "action": {
                "type": "text",
                "payload": str({"option_button": str(labels[1][0])}),
                "label": labels[1][1]
            },
            "color": "default"
        }],
        [{
            "action": {
                "type": "text",
                "payload": str({"option_button": str(labels[2][0])}),
                "label": labels[2][1]
            },
            "color": "default"
        },
        {
            "action": {
                "type": "text",
                "payload": str({"option_button": str(labels[3][0])}),
                "label": labels[3][1]
            },
            "color": "default"
        }]
